module instruction_memory(instruction_address,instruction_data);
  import common_pkg::*;
  ...
  initial begin
    $readmemh("instruction_memory.mem", memory, INSTRUCTION_MEMORY_ADDRESS_WIDTH'('h0), INSTRUCTION_MEMORY_ADDRESS_WIDTH'('hFF));
    $readmemh("instruction_memory.mem", memory, INSTRUCTION_MEMORY_ADDRESS_WIDTH'('h0), INSTRUCTION_MEMORY_ADDRESS_WIDTH'('hFF));
